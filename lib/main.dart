...
void main() {
  ...
  runApp(ModelProvider(modelCommand: modelCommand, child: MyApp()));
}
    ...
    return Scaffold(
        appBar: AppBar(title: Text('Weather App'), actions: <Widget>[
          ...
          PopupMenuButton<int>(
              ...
              tooltip: 'Select how much date you want',
              onSelected: ModelProvider.of(context).addCitiesCommand,
              itemBuilder: (context) {
                return menuNumbers
                        ...
                        child: Column(
                          children: <Widget>[
                            SliderItem(
                              sliderState: true,
                              command:
                                  ModelProvider.of(context).radioCheckedCommand,
                            ),
                            Container(
                              padding: EdgeInsets.all(10.0),
